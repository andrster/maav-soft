...
rrt::rrt(const YAML::Node& config) : 
...
*/
bool rrt::isCollision(const point3d& query, const OcTree* tree)
{
...
Path rrt::operator()(const Waypoint& start, const Waypoint& goal, const std::shared_ptr<octomap::OcTree> tree)
{   
    // TODO: GET MAP ORIGIN
